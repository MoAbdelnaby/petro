...
class Kernel extends ConsoleKernel
{
    ...
    {
         $schedule->command('area:duration-daily today')->everyFiveMinutes()->timezone('Asia/Riyadh');
...
//         $schedule->command('queue:work --tries=3')->everyMinute()->withoutOverlapping();
         ...
         $schedule->command('branch-status:update')->everyFifteenMinutes()->timezone('Asia/Riyadh');
    }
