                                ...
                                <form  method="POST" action="{{ route('packages.store') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea rows="2"  name="desc" class="form-control" id="desc" placeholder="{{__('app.saas.packages.table.desc')}}">{{ old('desc') }}</textarea>
                                            @error('desc')
                                            <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                             </span>
                                        ...
                                        <div id="price_monthly" class="form-group col-md-12">
                                        ...
                                        <div id="price_yearly" class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12" id="start_date">
                                        ...
                                        <div class="form-group col-md-12" id="end_date">
