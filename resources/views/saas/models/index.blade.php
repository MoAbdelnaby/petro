...
@section('page_title')
    {{__('app.saas.models.page_title.index')}}
@endsection
@section('meta')
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">{{__('app.saas.models.page_title.index')}}</h4>
                            </div>
                        </div>
                        <div class="text-center" style="width:400px; margin:0 auto;">
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                <div class="row justify-content-between">
                                        ...
                                        <div id="user_list_datatable_info" class="dataTables_filter">
                                            <form class="mr-3 position-relative">
                                                <div class="form-group mb-0">
                                                    <input type="text" class="form-control" id="generalmodelSearch" placeholder="{{__('app.saas.models.search')}}" aria-controls="user-list-table">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="user-list-files d-flex float-right">
                                            <a class="iq-bg-primary" href="{{route('models.create')}}" >
                                                <i class="ri-user-add-line"></i> &nbsp;{{__('app.saas.models.create_new')}}
                                            </a>
                                ...
                                <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                    <thead>
                                    <tr>
                                        <th>{{__('app.saas.models.table.name')}}</th>
                                        <th>{{__('app.saas.models.table.price')}}</th>
                                        <th>{{__('app.saas.models.table.description')}}</th>
                                        <th>{{__('app.saas.models.table.parent_model')}}</th>
                                        ...
                                        <tr id="row{{$item->id}}">
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    @can('edit-models')
                                                    <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('models.edit',[$item->id]) }}"><i class="ri-pencil-line"></i></a>
                                                    @endcan
                                                        @can('delete-models')
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="delete_option('saas/models');">{{__('app.saas.models.delete')}}</button>
                </div>
            </div>
        </div>
    </div>
