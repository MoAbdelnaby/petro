...
@section('page_title')
    {{__('app.saas.modelfeatures.page_title.create')}}
@endsection
@section('meta')
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">{{__('app.saas.modelfeatures.page_title.create')}}</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <div class="new-user-info">
                                <form  method="POST" action="{{ route('modelfeatures.store') }}">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input  min="0" type="number"  name="price" class="form-control" id="price" placeholder="{{__('app.saas.modelfeatures.table.price')}}" value="{{ old('price') }}">
                                            @error('price')
