   ...
   <div class="container">
     <div class="row">
       <div class="form-group col-12 col-md-4">
         ...
         <input type="number" class="form-control" id="kilometer" min="1" aria-describedby="number of kilometers"
       ...
       <div class="form-group col-12 col-md-4">
         ...
         <input type="number" class="form-control" id="days" min="1" max="365" aria-describedby="number of days"
           placeholder="(1  - 365)">
