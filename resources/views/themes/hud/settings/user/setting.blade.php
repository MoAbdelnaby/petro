                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="v-pills-reminder-tab" data-toggle="pill"
                                               ...
                                               aria-selected="true">{{ __('app.mail_reminder') }}</a>
                                        </li>
                                    ...
                                    <div class="row">
                                        <div class="col-12 ">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane show active fade py-3" id="v-pills-branch">
                                                    <div class="">

                                                            <form id="userMailsetting" method="post" novalidate
                                                                  action="{{route('user.MailsettingUpdate')}}"
                                                                  class="reminder-form">
                                                                @csrf
                                                                <div class="row p-0 m-0">
                                                                    <div class="col-lg-4 col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">{{ __('app.selectMailType') }}</label>
                                                                            <select name="mail_notify" class="form-control">
{{--                                                                                <option value=""></option>--}}
                                                                                <option value="on" {{$notify== 'on' ? 'selected' : ''}}>ON</option>
                                                                                <option value="off" {{$notify == 'off' ? 'selected' : ''}}>OFF</option>
                                                                            </select>
                                                                        </div>
...
@push("js")
    <script>
        // $(document).on("change", "#picMailType", function () {
        //     if ($('#picMailType').val()) {
