            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">{{ __('app.Create_New_Service') }}</h4>
                    </div>
                </div>
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('app.service.arabic_name') }}"
                                            name="name_ar" id="name_ar" value="{{ old('name_ar') }}"
                                            class="form-control" />
                                    ...
                                    <div class="form-group" style="text-align: center">
                                        <div class="kt-avatar" id="kt_profile_avatar_2">
                                            ...
                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                ...
                                                <input type="file" name="image" accept="image/png, image/gif, image/jpg" />
                                            </label>
