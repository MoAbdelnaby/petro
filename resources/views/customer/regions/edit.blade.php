                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12" style="text-align: center">
                                            <div class="kt-avatar" id="kt_profile_avatar_2">
                                                <div class="kt-avatar__holder" style="width: 90%;background-image: url({{ $item->photo ? url('storage/'.$item->photo): ( session()->has('darkMode') ? url('/images/models/dark/branch.svg'):url('/images/models/default/branch.svg') )}})"></div>
...
{{--                                            <label for="name">{{__('app.customers.branches.table.description')}} </label>--}}
{{--                                            <input required type="text" name="description" class="form-control" id="description" placeholder="{{__('app.customers.branches.table.description')}}" value="{{ old('description')? old('description') :$item->description }}">--}}
{{--                                            @error('description')--}}
{{--                                            <span class="invalid-feedback" role="alert">--}}
{{--                                                <strong>{{ $message }}</strong>--}}
{{--                                            </span>--}}
