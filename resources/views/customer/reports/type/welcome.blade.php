                                ...
                                <div class="row col-12 p-0 m-0 mb-3 menu-and-filter menu-and-filter--custom">
                                    <div class="col-8">
                                        <ul class="nav nav-tabs nav-tabs--custom" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="@if(request('show_by') != null) {{route('reports.show',array_merge(['type'=>'welcome'], request()->toArray()))}} @else {{ route('reports.show','welcome')}} @endif">{{ __('app.Welcome_Message') }}</a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <div class="col-4">
                                        <div class="d-flex justify-content-end position-relative filter-cont">
                                            @include('customer.reports.extra._filter',['type' => 'welcome'])
                                        </div>
                                    </div>
                                </div>
...
@push('js')
    ...
    <script>
        ...
        barChart('BranchWelcomeBar',charts.bar, info);
        @endif
        /**************** End Bar Chart****************/

        /**************** Start Line Chart ************/
        @if(count($report['charts']))
        $("#BranchWelcomeLineCon").show();
        lineChart('BranchWelcomeLine',charts.bar, info);
        @endif
        /************** End Line Chart ************/

        /**************** Start SideBar Chart ************/
        @if(count($report['charts']))
        $("#BranchWelcomeSideBarCon").show();
        sideBarChart('BranchWelcomeSideBar',charts.bar, info);
        @endif
        /************** End SideBar Chart ************/

        /********************** Start Circle Chart ************/
        @if(count($report['charts']))
        $("#WelcomeCircleCon").show();
        info.columns.forEach(function (col) {
            pieChart(`WelcomeCircle${col}`,charts.circle[col],info)
        });
        @endif
        /**************** End Circle Chart ***************/
