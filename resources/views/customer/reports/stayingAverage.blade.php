                        ...
                        <div class="iq-card-body">
                            <div>
                                <div class="row col-12 p-0 m-0 mb-3 menu-and-filter">
                                    <div class="col">
                                        <ul class="nav nav-tabs nav-tabs--custom" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                   href="@if(request('filter_type') != null) {{route('report.filter',array_merge(['type'=>'backout'], request()->toArray()))}} @else {{ route('reports.index','backout')}} @endif">{{ __('app.backout') }}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active"
                                                   href="@if(request('filter_type') != null) {{route('report.filter',array_merge(['type'=>'stayingAverage'], request()->toArray()))}} @else {{ route('reports.index','stayingAverage')}} @endif">{{ __('app.staying_car_average') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="related-heading mb-3 m-0 row col-12 related-heading--custom">
                                    <h2 class="p-0 col">{{ __('app.StayingAverage_reports') }}</h2>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active">
                                        @if(count($charts))
                                            <div class="row">
                                                <div class="pt-4 mb-5 col-md-12" id="BranceStayingAverageLineCon"
                                                     style="display: none">
                                                    <div id="BranceStayingAverageLine" class="chartDiv"
                                                         style="min-height: 450px"></div>
                                                </div>
                                                <div class="pt-4 mb-5 col-md-12" id="BranchStayingAverageBarCon"
                                                     style="display: none">
                                                    <div id="BranchStayingAverageBar" class="chartDiv"
                                                         style="min-height: 450px"></div>
                                                </div>
                                                <div class="pt-4 mb-5 col-md-12" id="BranchStayingAverageSmoothCon"
                                                     style="display: none">
                                                    <div id="BranchStayingAverageSmooth" class="chartDiv"
                                                         style="min-height: 450px"></div>
                                                </div>
                                            </div>
                                        @else
...
@endsection
@push('js')
    <script src="{{asset('js/report/stayingAverage.js')}}"></script>
    <script>
        /****** Inovice Chart ******/
        ...
        /************* Start Bar Chart ****************/
        @if(count($charts))
        $("#BranchStayingAverageBarCon").show();
        comparisonStayingBar('BranchStayingAverageBar', @json($charts));
        @endif
        /**************** End Bar Chart****************/

        /**************** Start Line Chart ************/
        @if(count($charts))
        $("#BranceStayingAverageLineCon").show();
        comparisonStayingLine('BranceStayingAverageLine', @json($charts));
        @endif
        /************** End Line Chart ************/
    </script>
@endpush
