                        ...
                        <div class="iq-card-body">
                            <div>
                                <div class="row col-12 p-0 m-0 mb-3 menu-and-filter">
                                    <div class="col">
                                        <ul class="nav nav-tabs nav-tabs--custom" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                   href="@if(request('filter_type') != null) {{route('report.filter',array_merge(['type'=>'invoice'], request()->toArray()))}} @else {{ route('reports.index','invoice')}} @endif">{{ __('app.Staying') }}</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <div class="related-heading mb-3 m-0 row col-12 related-heading--custom">
                                    <h2 class="p-0 col">{{ __('app.Stayings_reports') }}</h2>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active">
                                        @if(count($charts))
                                            <div class="row">
                                                <div class="pt-4 mb-5 col-md-12" id="BranceStayingLineCon" style="display: none">
                                                    <div id="BranceStayingLine" class="chartDiv" style="min-height: 450px"></div>
                                                </div>
                                                <div class="pt-4 mb-5 col-md-12" id="BranchStayingBarCon"
                                                     style="display: none">
                                                    <div id="BranchStayingBar" class="chartDiv" style="min-height: 450px"></div>
                                                </div>
                                                <div class="pt-4 mb-5 col-md-12" id="BranchStayingSmoothCon" style="display: none">
                                                    <div id="BranchStayingSmooth" class="chartDiv"
                                                         style="min-height: 450px"></div>
                                                </div>
                                                <div class="pt-4 mb-5 col-md-12" id="BranchStayingTrendLineCon" style="display: none">
                                                    <div id="BranchStayingTrendLine" class="chartDiv"
                                                         style="min-height: 450px"></div>
                                                </div>
                                            </div>
                                        @else
...
@endsection
@push('js')
    <script src="{{asset('js/report/stayingRatio.js')}}"></script>
    <script>
        /****** Inovice Chart ******/
        ...
        comparisonStayingBar('BranchStayingBar', @json($charts, JSON_THROW_ON_ERROR));
        @endif
        /**************** End Bar Chart****************/

        /**************** Start Line Chart ************/
        @if(count($charts))
        $("#BranceStayingLineCon").show();
        comparisonStayingLine('BranceStayingLine', @json($charts, JSON_THROW_ON_ERROR));
        @endif
        /************** End Line Chart ************/
        /**************** Start Line Chart ************/
        @if(count($charts))
        $("#BranchStayingTrendLineCon").show();
        comparisonStayingTrendLine('BranchStayingTrendLine', @json($charts, JSON_THROW_ON_ERROR));
        @endif
        /************** End Line Chart ************/
    </script>
@endpush
