                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" onclick="MeasureConnectionSpeed()"  type="button">Button</button>
                            </div>
                            @error('branch_id')
...
@section('scripts')
    <script>
        ...
        var optsDowload = {
            ...
            lineWidth: 0.044, // The line thickness
        ...
        var optsUpload = {
            angle: 0, // The span of the gauge arc
            lineWidth: .044, // The line thickness
            radiusScale: 1, // Relative radius
            pointer: {
                length: 0.6, // // Relative to gauge radius
                strokeWidth: 0.035, // The thickness
        ...
        var gauge = new Gauge(target).setOptions(optsDowload); // create sexy gauge!
