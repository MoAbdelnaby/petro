                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="row col-12 p-0 m-0 mb-3 menu-and-filter">
                                <div class="col p-0">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{route('config.index','place')}}">{{ __('app.Place') }}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('config.index','plate')}}">{{ __('app.Plate') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    @include('customer.config.includes._place')
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.chart-type.charts > li > a.test').on("click", function (e) {
                ...
                else if ($(this).hasClass('chart-6')) {
                    var div = $(this).closest('.iq-card ').find('.chartDiv');
                    div.attr("id", Date.now())
                    chart6(div.attr('id'));
                }
                else if ($(this).hasClass('chart-7')) {
                    var div = $(this).closest('.iq-card ').find('.chartDiv');
                    div.attr("id", Date.now())
                    chart7(div.attr('id'));
                }
            ...
            function chart1(id) {
                am4core.ready(function () {
                    ...
                    chart.data = [
                        {
                            category: "{{ __('app.Place1') }}",
                            first: 40,
                            second: 55,
                        },
                        {
                            category: "{{ __('app.Place2') }}",
                            first: 30,
                            second: 78,
                        },
                        {
                            category: "{{ __('app.Place3') }}",
                            first: 27,
                            second: 40,
                        },
                        {
                            category: "{{ __('app.Place4') }}",
                            first: 50,
                            second: 33,
                        }
                    ]
            ...
            function chart3(divId) {
                ...
                am4core.ready(function () {
                    ...
                    series2.dataFields.valueYid="germany";
