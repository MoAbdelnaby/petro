                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="related-product-block position-relative row col-12 m-0 p-0">
                                <div class="iconSearch">
                                    <span id="links">
                                        <div class="linksReg">
                                            <a href="{{route('customerRegions.index')}}" class="btn btn-sm">{{ __('app.Regions') }}</a>
                                            <a href="{{route('customerBranches.index')}}" class="btn btn-sm">{{ __('app.Branches') }}</a>
                                        </div>
                                ...
                                <div class="col-md-12 search-in-regions">
                                    <div class="form-search">
                                        <form id="mapfilter" action="{{route('map.filter')}}" method="post" class="row col-12 m-0 p-0">
                                            @csrf

                                        <div class="row col-12 border-bottom m-0 p-0">

                                                <div class="form-group">
                                                    <input type="radio" id="Region" value="regions" name="table" checked>
                                                    <label for="Region">{{ __('app.region') }}</label>
                                                </div>
                                                <div class="form-group">
                                                    <input type="radio" id="Branch" value="branches" name="table">
                                                    <label for="Branch">{{ __('app.branch') }}</label>
                                                </div>
                                                <div class="form-group">
                                                    <input type="radio" id="plate" value="carprofiles" name="table">
                                                    <label for="plate">{{ __('app.Plates') }}</label>
                                                </div>
                                            ...
                                            <div class="form-group col-12 searchInput m-0">
                                ...
                                <div class="col-md-3 col-sm-12">
                                    <ul class="nav nav-tabs regionsUl" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="firstMap-tab" data-toggle="tab" href="#firstMap" role="tab" aria-controls="" aria-selected="true">
                                                {{ __('app.Saudi_Map') }}
                                            </a>
                                        </li>
                                        @foreach($regions as $key=>$region)
                                            ...
                                            @endphp
                                            <li class="nav-item">
                                                <a class="nav-link " id="{{ $link_id }}-tab" data-toggle="tab" href="#{{ $link_id }}" role="tab" aria-controls="{{ $link_id }}" aria-selected="true">
                                                    {{ $region->name }}
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <span class="RegionsNameInMap"></span>
                                    <div class="tab-content" id="myTabContent">

                                        <div class="tab-pane fade active show" id="firstMap" role="tabpanel" aria-labelledby="firstMap-tab">
                                        ...
                                        @foreach($regions as $key=>$region)
                                            ...
                                            <div class="tab-pane fade " id="{{ $tab_id }}" role="tabpanel" aria-labelledby="{{ $tab_id }}-tab">
                                                <div class=" reg-img form-group" style="height: 530px;width: 700px;margin:0 auto;position: relative">
                                                    <img src="{{ asset("storage")."/".$region->photo }}" class="regionImage" style="display: block" >
