                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="new-user-info">
                                <form  method="POST" id="profile" action="{{ route('users.updateprofile') }}"  enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="form-group col-md-12" style="text-align: center">
                                            <div class="kt-avatar" id="kt_profile_avatar_2">
                                                <div class="kt-avatar__holder" style="background-image: url({{ $user->avatar  ? url('storage/'.$user->avatar) :  'https://image.shutterstock.com/image-vector/robot-icon-bot-sign-design-260nw-715962319.jpg'}})"></div>
                                                <label class="kt-avatar__upload"  data-toggle="kt-tooltip" title="{{__('app.settings.changeprofile')}}">
                                                    <i class="ri-pencil-line"></i>
                                                    <input type='file' name="avatar" accept="image/png, image/gif, image/jpeg"/>
                                                </label>
                                                <span class="form-text text-muted">{{__('app.settings.changeprofile_desc')}}</span>
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-lg-4">
                                            ...
                                            <input name="phone" type="number"
                                                   ...
                                                   id="phone" placeholder="{{__('app.auth.phone')}}"
