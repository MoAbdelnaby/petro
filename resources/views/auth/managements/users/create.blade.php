                            ...
                            <div class="new-user-info">
                                <form  method="POST"  id="createuser"  action="{{ route('users.store') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="package">{{__('app.auth.package')}}</label>
                                            <input type="checkbox" style="display: block; width: 46px;" name="package" checked="checked" class="form-control  @error('package') is-invalid @enderror" >
                                            @error('package')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
