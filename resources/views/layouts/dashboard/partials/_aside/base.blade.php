        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu p-0 m-0">
                ...
                @if(auth()->user()->type != "subcustomer")
                    <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customerhome" ? 'active': ''}}">
                        <div class="col-12 justify-content-center">
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('home')}}" class="iq-waves-effect">
                                    <img alt="Logo" src="{{resolveDark()}}/img/icon_menu/homemenu.svg" class="img-fluid"/>
                                </a>
                            </div>
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('home')}}" class="iq-waves-effect menutext">{{__('app.website_name')}}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customer/map" ? 'active': ''}}">
                        <div class="col-12 justify-content-center">
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('map.index')}}" class="iq-waves-effect">
                                    <img src="{{resolveDark()}}/img/icon_menu/map.svg" alt="product-image" class="img-fluid">
                                </a>
                            </div>
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('map.index')}}" class="iq-waves-effect menutext">{{ __('app.Map') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    @can('list-mypackages')
                        <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customer/customerPackages" ? 'active': ''}}" >
                            <div class="col-12 justify-content-center">
                                <div class="iq-product-cover d-flex justify-content-center">
                    ...
                    @can('list-CustomerUsers')
                        <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customer/customerUsers" ? 'active': ''}}">
                            <div class="col-12 justify-content-center">
                                <div class="iq-product-cover d-flex justify-content-center">
                                    <a href="{{route('customerUsers.index')}}" class="iq-waves-effect"><img
                                            src="{{resolveDark()}}/img/icon_menu/users.svg" alt="product-image" class="img-fluid"></a>
                                </div>
                                <div class="iq-product-cover d-flex justify-content-center"><a
                    ...
                    @can('list-CustomerUsers')
                        <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customer/activities" ? 'active': ''}}">
                            <div class="col-12 justify-content-center">
                                <div class="iq-product-cover d-flex justify-content-center">
                    ...
                    @endcan
                    <div class="border-bottom clearfix"></div>
                    <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customer/config/place/get" ? 'active': ''}}" >
                        <div class="col-12 justify-content-center">
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('config.index','place')}}" class="iq-waves-effect"><img
                                        src="{{resolveDark()}}/img/icon_menu/config.svg" alt="Config" class="img-fluid"></a>
                            </div>
                            <div class="iq-product-cover d-flex justify-content-center"><a
                                    href="{{route('config.index','place')}}" class="iq-waves-effect menutext">{{ __('app.config') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="border-bottom clearfix"></div>
                    <div class="row justify-content-center p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/customer/reports/place/get" ? 'active': ''}}">
                        <div class="col-12 justify-content-center">
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('reports.index','place')}}" class="iq-waves-effect"><img
                                        src="{{resolveDark()}}/img/icon_menu/report.svg" alt="Reports" class="img-fluid"></a>
                            </div>
                            <div class="iq-product-cover d-flex justify-content-center"><a
                    ...
                    <div class="row justify-content-center  p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/settings/reminder" ? 'active': ''}} ">
                        <div class="col-12 justify-content-center">
                        <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{route('setting.reminder')}}" class="iq-waves-effect"><img
                                        src="{{resolveDark()}}/img/icon_menu/settings.svg" alt="Settings" class="img-fluid"></a>
                            </div>
                            <div class="iq-product-cover d-flex justify-content-center"><a
                    ...
                    <div class="row justify-content-center  p-0 m-0 py-3 item-menu {{ $_SERVER['REQUEST_URI'] == "/connection-speed" ? 'active': ''}} ">
                        <div class="col-12 justify-content-center">
                            <div class="iq-product-cover d-flex justify-content-center">
                        ...
                        <div class="col-12 justify-content-center">
                            <div class="iq-product-cover d-flex justify-content-center">
                                <a href="{{url('settings/translations')}}" class="iq-waves-effect"><img
                                        src="{{resolveDark()}}/img/icon_menu/translate.svg" alt="Reports" class="img-fluid"></a>
                            </div>
                            <div class="iq-product-cover d-flex justify-content-center"><a
                ...
                @else
                    ...
                    <li class="iq-menu-title"><i class="ri-subtract-line"></i><span>{{ __('app.dashboard') }}</span></li>
                    <li>
                        ...
                        <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            @can('list-roles')
                                <li><a href="{{route('roles.index')}}"><i
                                            class="ri-file-edit-line"></i>{{__('app.side_bar.auth_control.roles')}}</a>
                                </li>
                            @endcan
                        ...
                        <ul id="saas" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            @can('list-packages')
                                <li><a href="{{route('packages.index')}}"><i
                                            class="ri-profile-line"></i>{{__('app.side_bar.saas_control.packages')}}</a>
                                </li>
                            @endcan
                            @can('list-models')
                            ...
                            @can('list-features')
                                <li><a href="{{route('features.index')}}"><i
                                            class="ri-profile-line"></i>{{__('app.side_bar.saas_control.features')}}</a>
                                </li>
                            @endcan
