...
function comparisonWelcomeBar(id, data) {
    am4core.ready(function () {
        ...
        createSeries("welcome", "Welcome");
        createSeries("no_welcome", "No Welcome");
...
function comparisonWelcomeLine(divId, data) {
    am4core.ready(function () {
        // Themes begin
        am4core.useTheme(am4themes_animated);
        ...
        series1.dataFields.valueY = "welcome";
        series1.dataFields.categoryX = "branch";
        series1.name = "Welcome";
        series1.bullets.push(new am4charts.CircleBullet());
        series1.tooltipText = "Welcome {categoryX}: {valueY} Record";
        series1.legendSettings.valueText = "{valueY}";
        series1.visible = false;

        var series2 = chart.series.push(new am4charts.LineSeries());
        series2.dataFields.valueY = "no_welcome";
        series2.dataFields.categoryX = "branch";
        series2.name = "No Welcome";
        series2.bullets.push(new am4charts.CircleBullet());
        series2.tooltipText = "No Welcome {categoryX}: {valueY} Record";
...
function comparisonWelcomeTrendLine(divId, data) {
    ...
    am4core.ready(function () {
        ...
        columnSeries.name = "Welcome (Record)";
        columnSeries.dataFields.valueY = "welcome";
        ...
        lineSeries.name = "No Welcome (Record)";
        lineSeries.dataFields.valueY = "no_welcome";
