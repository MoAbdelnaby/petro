...
----------------------------------------------*/
    ...
    $(document).ready(function () {
        ...
        $('.scroll-vertical-custom-div').width(function () {
            ...
            //     $(this).parents('.product-miniature').find('.branchesAll').toggle();
            //     $(this).find('i').toggleClass('fa-times-circle fa-info');
            // })
            // $('.closebranchesAll').click(function(){
            //     $(this).parents('.branchesAll').toggle();
            //     $(this).parents('.product-miniature').find('.showbranchesAll i').toggleClass('fa-times-circle fa-info');
            // });
